...
var App = function () {
    ...
    var handleUniform = function () {
        ...
        var test = $("table input[type=checkbox]:not(.toggle, .make-switch), table input[type=radio]:not(.toggle, .star, .make-switch), input[type=radio].uniformable");
        if (test.size() > 0) {
            test.each(function () {
...
//        $('.make-switch').bootstrapSwitch();
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            var html = '';
            var img_load = '/theme/img/loading-spinner-blue.gif';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="'+img_load+'" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {    
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="'+img_load+'" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
