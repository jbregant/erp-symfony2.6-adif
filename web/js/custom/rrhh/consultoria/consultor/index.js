...
dt_consultoria_consultor = dt_datatable($('#table-consultoria_consultor'), {
    ajax: __AJAX_PATH__ + 'consultor/index_table/',
    columnDefs: [
        {
        ...
        },
        {
            ...
            "render": function (data, type, full, meta) {
                ...
                return '<a href="' + full_data.show + '" class="btn btn-xs blue tooltips" data-original-title="Ver detalle">\n\
                        ...
                        +
                        (full_data.cuenta_corriente !== undefined ?
                        ...
                        (
                            full_data.desactivar !== undefined ?
                                '<a href="' + full_data.desactivar + '" class="btn btn-xs btn-danger tooltips consultor_desactivar" data-toggle="tooltip" data-original-title="Desactivar"><i class="fa fa-ban"></i></a>' 
                                : ''
                        )
                        ;
            }
...
$(document).on('click', '.consultor_desactivar', function (e) {
        e.preventDefault();
        var a = $(this);
        show_confirm({
            title: 'Desactivar consultor',
            msg: 'Confirma desactivar al consultor <b>' + $(this).parents('tr').find('td:nth-child(' + (indexDTToVisible(dt_consultoria_consultor_column_index.razonSocial) + 1) + ')').text() + '</b>?',
            callbackOK: function () {
