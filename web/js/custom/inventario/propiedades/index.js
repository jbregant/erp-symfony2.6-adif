...
var dt_propiedades_column_index = {
  id: index++,
  multiselect: index++,
  denominacion: index++,
...
dt_propiedades = dt_datatable($('#table-propiedades'), {
  ajax: __AJAX_PATH__ + 'propiedades/index_table/',
  columnDefs: [{
      "targets": dt_propiedades_column_index.multiselect,
      "data": "ch_multiselect",
    ...
    {
      "targets": dt_propiedades_column_index.acciones,
      "data": "actions",
      "render": function(data, type, full, meta) {
        var full_data = full[dt_propiedades_column_index.acciones];
    ...
    },
    {
      ...
      targets: [
        dt_propiedades_column_index.multiselect
      ]
    },
    {
