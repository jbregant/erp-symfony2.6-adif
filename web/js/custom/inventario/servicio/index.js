...
dt_servicio = dt_datatable($('#table-servicio'), {
ajax: __AJAX_PATH__ + 'servicio/index_table/',
columnDefs: [
{
"targets": dt_servicio_column_index.multiselect,
"data": "ch_multiselect",
...
{
"targets": dt_servicio_column_index.acciones,
"data": "actions",
"render": function (data, type, full, meta) {
var full_data = full[dt_servicio_column_index.acciones];
...
targets: [
dt_servicio_column_index.multiselect
]
},
{
