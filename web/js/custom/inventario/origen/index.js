...
dt_origen = dt_datatable($('#table-origen'), {
ajax: __AJAX_PATH__ + 'origen/index_table/',
columnDefs: [
{
"targets": dt_origen_column_index.multiselect,
"data": "ch_multiselect",
...
{
"targets": dt_origen_column_index.acciones,
"data": "actions",
"render": function (data, type, full, meta) {
var full_data = full[dt_origen_column_index.acciones];
...
targets: [
dt_origen_column_index.multiselect
]
},
{
