...
dt_atributo = dt_datatable($('#table-atributo'), {
ajax: __AJAX_PATH__ + 'atributo/index_table/',
columnDefs: [
{
"targets": dt_atributo_column_index.multiselect,
"data": "ch_multiselect",
...
{
"targets": dt_atributo_column_index.acciones,
"data": "actions",
"render": function (data, type, full, meta) {
var full_data = full[dt_atributo_column_index.acciones];
...
targets: [
dt_atributo_column_index.multiselect
]
},
{
