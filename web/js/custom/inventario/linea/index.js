...
dt_linea = dt_datatable($('#table-linea'), {
ajax: __AJAX_PATH__ + 'linea/index_table/',
columnDefs: [
{
"targets": dt_linea_column_index.multiselect,
"data": "ch_multiselect",
...
{
"targets": dt_linea_column_index.acciones,
"data": "actions",
"render": function (data, type, full, meta) {
var full_data = full[dt_linea_column_index.acciones];
...
targets: [
dt_linea_column_index.multiselect
]
},
{
