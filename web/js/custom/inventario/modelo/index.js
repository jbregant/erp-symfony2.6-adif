...
dt_modelo = dt_datatable($('#table-modelo'), {
ajax: __AJAX_PATH__ + 'modelo/index_table/',
columnDefs: [
{
"targets": dt_modelo_column_index.multiselect,
"data": "ch_multiselect",
...
{
"targets": dt_modelo_column_index.acciones,
"data": "actions",
"render": function (data, type, full, meta) {
var full_data = full[dt_modelo_column_index.acciones];
...
targets: [
dt_modelo_column_index.multiselect
]
},
{
