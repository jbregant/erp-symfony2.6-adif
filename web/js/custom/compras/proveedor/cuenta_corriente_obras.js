...
$(document).ready(function(){
    dt_cc = dt_datatable($('#table-cuenta-corriente'), {
        // ajax: __AJAX_PATH__ + 'proveedor/'+id_proveedor+'/cuentacorriente/indextable',
        columnDefs: [
            ...
            // { data: "oc.saldo", targets: dt_cc_column_index.saldo, className: 'text-right' },
            // { data: "op", targets: dt_cc_column_index.op, 
            //    render : function (op, type, full, meta) {
            //         if (op.id != null){
            //             return '<a href="'+__AJAX_PATH__ + 'ordenpago/'+op.id+'">'+ op.numero + ' - ' + op.estado +'</a>'
            //         }
            //         return ''
            //     }
            // },
            // { 
            //     data: "id", targets: dt_cc_column_index.acciones, className: 'text-center', render : function (data, type, full, meta) {
            //         return '';
            //     }
            // },
