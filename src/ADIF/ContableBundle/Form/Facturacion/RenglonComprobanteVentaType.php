...
class RenglonComprobanteVentaType extends AbstractType {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'ADIF\ContableBundle\Entity\Facturacion\RenglonComprobanteVenta'
        ));
    }
    ...
    public function getName() {
        return 'adif_contablebundle_rengloncomprobanteventa';
    }
