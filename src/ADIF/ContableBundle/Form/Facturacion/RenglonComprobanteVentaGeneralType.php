...
class RenglonComprobanteVentaGeneralType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ->add('conceptoVentaGeneral', EntityType::clase, array(
                    'class' => 'ADIF\ContableBundle\Entity\Facturacion\ConceptoVentaGeneral',
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'ADIF\ContableBundle\Entity\Facturacion\RenglonComprobanteVentaGeneral'
        ));
    }
    ...
    public function getName() {
        return 'adif_contablebundle_facturacion_rengloncomprobanteventageneral';
    }
