...
class ConceptoPresupuestarioRemuneracionType extends AbstractType {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'ADIF\ContableBundle\Entity\ConceptoPresupuestarioRemuneracion'
        ));
    }
    ...
    public function getName() {
        return 'adif_contablebundle_conceptopresupuestarioremuneracion';
    }
