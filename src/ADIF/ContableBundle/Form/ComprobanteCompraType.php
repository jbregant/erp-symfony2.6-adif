...
class ComprobanteCompraType extends AbstractType {
    private $emContable;
    private $emCompras;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                /*        
                $builder->add('renglonesComprobante', new RenglonComprobanteCompraType(), array(
                    
                ));
                 
                $builder->add('renglonesPercepcion', new RenglonPercepcionType(), array(
                    
                ));

                $builder->add('renglonesImpuesto', new RenglonImpuestoType(), array(
                    
                ));

                $builder->add('adicionales', new AdicionalComprobanteCompraType(), array(
