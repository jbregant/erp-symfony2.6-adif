...
class PolizaSeguroObraType extends AbstractType {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'ADIF\ContableBundle\Entity\Obras\PolizaSeguroObra'
        ));
    }
    ...
    public function getName() {
        return 'adif_contablebundle_obras_polizaseguroobra';
    }
