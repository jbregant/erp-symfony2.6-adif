...
/**
 * EstadoRenglonRetencionLiquidacion
 * 
 * Indica el estado del RenglonRetencionLiquidacion
 *
 * @author Darío Rapetti
 * created 09/06/2015
 * 
 * @ORM\Table(name="estado_renglon_retencion_liquidacion")
 * @ORM\Entity
 * @UniqueEntity("denominacion", message="La denominación ingresada ya se encuentra en uso.")
 */
class EstadoRenglonRetencionLiquidacion extends BaseAuditoria implements BaseAuditable {
     ...
     * @return EstadoRenglonRetencionLiquidacion
     */
