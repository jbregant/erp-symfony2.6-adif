...
/**
 * Description of TipoConceptoPresupuestarioRemuneracion:
 * 
 * @ORM\Table(name="tipo_concepto_presupuestario_remuneracion")
 * @ORM\Entity
 * @UniqueEntity(
 ...
 * )
 */
class TipoConceptoPresupuestarioRemuneracion extends BaseAuditoria implements BaseAuditable {
     ...
     * @return TipoConceptoPresupuestarioRemuneracion
     */
