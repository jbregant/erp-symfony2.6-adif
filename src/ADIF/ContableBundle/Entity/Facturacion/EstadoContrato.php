 ...
 * created 23/01/2015
 * 
 * @ORM\Table(name="estado_contrato")
 * @ORM\Entity
 * @UniqueEntity("denominacionEstado", message="La denominación ingresada ya se encuentra en uso.")
 */
class EstadoContrato extends BaseAuditoria implements BaseAuditable {
    ...
    /**
     * Inidica si la observacion del Contrato es obligatoria o no.
     * 
     * @var boolean
     *
     * @ORM\Column(name="requiere_observacion", type="boolean", nullable=false)
     */
    protected $requiereObservacion;
    ...
    /**
     * Set requiereObservacion
     *
     * @param boolean $requiereObservacion
     * @return EstadoContrato
     */
    public function setRequiereObservacion($requiereObservacion) {
    ...
    /**
     * Get requiereObservacion
     *
     * @return boolean 
     */
    public function getRequiereObservacion() {
