...
/**
 * EstadoReconocimientoEgresoValor 
 * 
 * Indica el estado de ReconocimientoEgresoValor
 * 
 * @ORM\Table(name="estado_reconocimiento_egreso_valor")
 * @ORM\Entity
 * @UniqueEntity("denominacionEstado", message="La denominación ingresada ya se encuentra en uso.")
 */
class EstadoReconocimientoEgresoValor extends BaseAuditoria implements BaseAuditable {
