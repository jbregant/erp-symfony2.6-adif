...
/**
 * EstadoReposicionEgresoValor 
 * 
 * Indica el estado de ReconocimientoEgresoValor
 * 
 * @ORM\Table(name="estado_reposicion_egreso_valor")
 * @ORM\Entity
 * @UniqueEntity("denominacionEstado", message="La denominación ingresada ya se encuentra en uso.")
 */
class EstadoReposicionEgresoValor extends BaseAuditoria implements BaseAuditable {
     ...
     * @return EstadoReposicionEgresoValor
     */
