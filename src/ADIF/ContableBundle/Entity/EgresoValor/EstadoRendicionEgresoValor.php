...
/**
 * EstadoRendicionEgresoValor 
 * 
 * Indica el estado de la RendicionEgresoValor
 *
 * @author Manuel Becerra
 * created 21/01/2015
 * 
 * @ORM\Table(name="estado_rendicion_egreso_valor")
 * @ORM\Entity
 * @UniqueEntity("denominacionEstado", message="La denominación ingresada ya se encuentra en uso.")
 */
class EstadoRendicionEgresoValor extends BaseAuditoria implements BaseAuditable {
     ...
     * @return EstadoRendicionEgresoValor
     */
