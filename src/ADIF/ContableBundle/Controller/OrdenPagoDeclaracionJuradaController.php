 ...
 * @Route("/ordenpago")
 */
class OrdenPagoDeclaracionJuradaController extends OrdenPagoBaseController {
     ...
     *
     * @Route("/declaracion_jurada/{id}", name="ordenpagodeclaracionjurada_show")
     * @Method("GET")
     ...
     *
     * @Route("/declaracion_jurada/pagar", name="ordenpagodeclaracionjurada_pagar")
     * @Method("POST")   
     */
     ...
     *
     * @Route("/declaracion_jurada/print/{id}", name="ordenpagodeclaracionjurada_print")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/declaracion_jurada/reemplazar_pago", name="ordenpagodeclaracionjurada_reemplazar_pago")
     * @Method("POST")   
     */
     ...
     * Anular OrdenPago
     *
     * @Route("/declaracion_jurada/{id}/anular", name="ordenpagodeclaracionjurada_anular")
     * @Method("GET")   
     */
    ...
    public function generarAsientoContableAnular($ordenPago, $user, $esContraasiento) {
        return $this->get('adif.asiento_service')
                        ->generarAsientoPagoDeclaracionJurada($ordenPago, $user, $esContraasiento);
    }
    ...
    public function generarAsientoContablePagar($ordenPago, $user) {
        return $this->get('adif.asiento_service')
                        ->generarAsientoPagoDeclaracionJurada($ordenPago, $user);
    }
    ...
    public function getPathReemplazarPago() {
        return 'ordenpago/declaracion_jurada';
    }
    ...
    public function anularActionCustom($ordenPago, $emContable, $autorizacionContable) {
        ...
        //$declaracionJuradaNueva = clone $ordenPago->getDeclaracionJurada();

        //$autorizacionContable->setDeclaracionJurada($declaracionJuradaNueva);

        //$declaracionJuradaNueva->setOrdenPago($autorizacionContable);
		
		$ddjj = $ordenPago->getDeclaracionJurada();
     ...
     * Pagar autorizacion contable
     *
     * @Route("/declaracion_jurada/form_pagar", name="ordenpagodeclaracionjurada_form_pagar")
     * @Method("POST")   
    ...
    /**
     * 
     * @Route("/declaracion_jurada/{id}/historico_general", name="ordenpagodeclaracionjurada_historico_general")
     * @Method("GET")
