...
class GananciaEmpleadoResolucion {
     ...
     * 
     * @ORM\ManyToOne(targetEntity="LiquidacionEmpleado", inversedBy="gananciasEmpleadoResolucion")
     * @ORM\JoinColumn(name="liquidacion_empleado_id", referencedColumnName="id")
     */
    ...
    /**
     *
     * @var \ADIF\RecursosHumanosBundle\Entity\ConceptoGananciaCalculadoResolucion
     * 
     * @ORM\OneToMany(targetEntity="ConceptoGananciaCalculadoResolucion", mappedBy="gananciaEmpleado", cascade={"all"})
     */
    protected $conceptos;
    ...
    /**
     * @var \ADIF\RecursosHumanosBundle\Entity\ResolucionGanancias
     * 
     * @ORM\ManyToOne(targetEntity="ResolucionGanancias")
     * @ORM\JoinColumn(name="resolucion_ganancias_id", referencedColumnName="id")
     */
    private $resolucionGanancias;
     ...
     * Add conceptos
     *
     * @param \ADIF\RecursosHumanosBundle\Entity\ConceptoGananciaCalculadoResolucion $conceptos
     * @return Ganancia
     */
    public function addConcepto(\ADIF\RecursosHumanosBundle\Entity\ConceptoGananciaCalculadoResolucion $conceptos) {
     ...
     * @param \ADIF\RecursosHumanosBundle\Entity\ConceptoGananciaCalculadoResolucion $conceptos
     */
    public function removeConcepto(\ADIF\RecursosHumanosBundle\Entity\ConceptoGananciaCalculadoResolucion $conceptos) {
    ...
    /**
     * Set resolucionGanancias
     *
     * @param \ADIF\RecursosHumanosBundle\Entity\ResolucionGanancias resolucionGanancias
     * @return GananciaEmpleado
     */
    public function setResolucionGanancias(\ADIF\RecursosHumanosBundle\Entity\ResolucionGanancias $resolucionGanancias) {
        $this->resolucionGanancias = $resolucionGanancias;

        return $this;
    }

    /**
     * Get resolucionGanancias
     *
     * @return \ADIF\RecursosHumanosBundle\Entity\ResolucionGanancias 
     */
    public function getResolucionGanancias() {
        return $this->resolucionGanancias;
    }
