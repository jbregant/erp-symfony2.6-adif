 ...
 * @ORM\Entity(repositoryClass="ADIF\PortalProveedoresBundle\Repository\EstadoNotificacionRepository")
 */
class EstadoNotificacion extends BaseAuditoria implements BaseAuditable
{
    /**
     * @var integer
     *
